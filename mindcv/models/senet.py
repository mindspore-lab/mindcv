...
def _cfg(url='', **kwargs):
    return {
        'url': url,
        'num_classes': 1000,
        'first_conv': 'layer0.0', 'classifier': 'classifier',
        **kwargs
    }
...
default_cfgs = {
    ...
    'seresnext26_32x4d': _cfg(url='https://download.mindspore.cn/toolkits/mindcv/senet/seresnext26_32x4d-5361f5b6.ckpt'),
    'seresnext50_32x4d': _cfg(url='https://download.mindspore.cn/toolkits/mindcv/senet/seresnext50_32x4d-fdc35aca.ckpt'),
...
class SENet(nn.Cell):
    ...
    def _make_layer(self,
                    ...
                    stride: int = 1,
                    downsample_kernel_size: int = 1,
                    downsample_padding: int = 0) -> nn.SequentialCell:
        downsample = None
...
def senet154(pretrained: bool = False, num_classes: int = 1000, in_channels=3, **kwargs):
    ...
    model = SENet(block=SEBottleneck, layers=[3, 8, 36, 3], group=64, reduction=16,
                  downsample_kernel_size=3, downsample_padding=1,  inplanes=128, input3x3=True, **kwargs)
...
def seresnet18(pretrained: bool = False, num_classes: int = 1000, in_channels=3, **kwargs):
    ...
    model = SENet(block=SEResNetBlock, layers=[2, 2, 2, 2], group=1, reduction=16, **kwargs)
...
def seresnet34(pretrained: bool = False, num_classes: int = 1000, in_channels=3, **kwargs):
    ...
    model = SENet(block=SEResNetBlock, layers=[3, 4, 6, 3], group=1, reduction=16, **kwargs)
...
def seresnet50(pretrained: bool = False, num_classes: int = 1000, in_channels=3, **kwargs):
    ...
    model = SENet(block=SEResNetBottleneck, layers=[3, 4, 6, 3], group=1, reduction=16, **kwargs)
...
def seresnet101(pretrained: bool = False, num_classes: int = 1000, in_channels=3, **kwargs):
    ...
    model = SENet(block=SEResNetBottleneck, layers=[3, 4, 23, 3], group=1, reduction=16, **kwargs)
...
def seresnet152(pretrained: bool = False, num_classes: int = 1000, in_channels=3, **kwargs):
    ...
    model = SENet(block=SEResNetBottleneck, layers=[3, 8, 36, 3], group=1, reduction=16, **kwargs)
...
def seresnext26_32x4d(pretrained: bool = False, num_classes: int = 1000, in_channels=3, **kwargs):
    ...
    model = SENet(block=SEResNeXtBottleneck, layers=[2, 2, 2, 2], group=32, reduction=16, **kwargs)
...
def seresnext50_32x4d(pretrained: bool = False, num_classes: int = 1000, in_channels=3, **kwargs):
    ...
    model = SENet(block=SEResNeXtBottleneck, layers=[3, 4, 6, 3], group=32, reduction=16, **kwargs)
...
def seresnext101_32x4d(pretrained: bool = False, num_classes: int = 1000, in_channels=3, **kwargs):
    ...
    model = SENet(block=SEResNeXtBottleneck, layers=[3, 4, 23, 3], group=32, reduction=16, **kwargs)
