...
default_cfgs = {
    'edgenext_xx_small': _cfg(url=''),
    'edgenext_x_small': _cfg(url=''),
    'edgenext_small': _cfg(url=''),
    'edgenext_base': _cfg(url=''),
    'edgenext_xx_small_bn_hs': _cfg(url=''),
    'edgenext_x_small_bn_hs': _cfg(url=''),
    'edgenext_small_bn_hs': _cfg(url=''),
}
...
@register_model
def edgenext_x_small(pretrained: bool = False,
...
@register_model
def edgenext_base(pretrained: bool = False,
                  num_classes: int = 1000,
                  in_channels: int = 3,
                  **kwargs) -> EdgeNeXt:
...
@register_model
def edgenext_xx_small_bn_hs(pretrained: bool = False,
                            num_classes: int = 1000,
                            in_channels: int = 3,
                            **kwargs) -> EdgeNeXt:
    """Get edgenext_xx_small_bn_hs model.
...
@register_model
def edgenext_x_small_bn_hs(pretrained: bool = False,
                           num_classes: int = 1000,
                           in_channels: int = 3,
                           **kwargs) -> EdgeNeXt:
    """Get edgenext_x_small_bn_hs model.
        Refer to the base class `models.EdgeNeXtBNHS` for more details."""
...
@register_model
def edgenext_small_bn_hs(pretrained: bool = False,
                         num_classes: int = 1000,
                         in_channels: int = 3,
                         **kwargs) -> EdgeNeXt:
    """Get edgenext_small_bn_hs model.
        Refer to the base class `models.EdgeNeXtBNHS` for more details."""
