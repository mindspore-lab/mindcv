"""Define Cross-Covariance Image Transformer model"""
...
default_cfgs = {
    'xcit_tiny_12_p16': _cfg(url='https://download.mindspore.cn/toolkits/mindcv/swin/swin_tiny_224.ckpt'),
}
...
def conv3x3(in_planes, out_planes, stride=1):
    ...
    return nn.SequentialCell([
        ...
        # nn.SyncBatchNorm(out_planes, use_batch_statistics=True)
...
class LPI(nn.Cell):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU,
        ...
        self.act = act_layer()
        # self.bn = nn.SyncBatchNorm(in_features, use_batch_statistics=True)
