...
class AugmentOp:
    ...
    def __call__(self, img):
        ...
        # default upper_bound RA impl is _LEVEL_DENOM (10)
...
def auto_augment_policy(name='originalr', hparams=None):
    hparams = hparams or _HPARAMS_DEFAULT
    if name == 'original':
...
def auto_augment_transform(config_str, hparams):
    ...
    Args:
        config_str: String defining configuration of auto augmentation. Consists of multiple sections separated by
            dashes ('-'). The first section defines the AutoAugment policy (one of 'original', 'originalr').
...
def rand_augment_transform(config_str, hparams):
    ...
    Args:
        config_str: String defining configuration of random augmentation. Consists of multiple sections separated
