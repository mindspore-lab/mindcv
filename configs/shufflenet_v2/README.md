...
|--------------------|-----------|------------|------------|-------------|----------------------------------------------------------------------------------------------------------------|----------|
| shufflenet_v2_x0.5 | D910x8-G |  60.68     | 82.44     | 1.37    | [yaml](https://github.com/mindspore-lab/mindcv/blob/main/configs/shufflenet_v2/shufflenet_v2_x0.5_ascend.yaml) | [weights](https://download.mindspore.cn/toolkits/mindcv/shufflenet/shufflenetv2/shufflenet_v2_05-a53c62b9.ckpt)  |
| shufflenet_v2_x1.0 | D910x8-G | 69.51     | 88.67     | 2.29     | [yaml](https://github.com/mindspore-lab/mindcv/blob/main/configs/shufflenet_v2/shufflenet_v2_x1.0_ascend.yaml) | [weights](https://download.mindspore.cn/toolkits/mindcv/shufflenet/shufflenetv2/shufflenet_v2_10-e6b8c4fe.ckpt)  |
| shufflenet_v2_x1.5 | D910x8-G | 72.59     | 90.79     | 3.53    | [yaml](https://github.com/mindspore-lab/mindcv/blob/main/configs/shufflenet_v2/shufflenet_v2_x1.5_ascend.yaml) | [weights](https://download.mindspore.cn/toolkits/mindcv/shufflenet/shufflenetv2/shufflenet_v2_15-e717dd88.ckpt)  |
| shufflenet_v2_x2.0 | D910x8-G |  75.14     | 92.13     | 7.44    | [yaml](https://github.com/mindspore-lab/mindcv/blob/main/configs/shufflenet_v2/shufflenet_v2_x2.0_ascend.yaml) | [weights](https://download.mindspore.cn/toolkits/mindcv/shufflenet/shufflenetv2/shufflenet_v2_20-ada6a359.ckpt)  |
...
mpirun -n 8 python train.py --config configs/shufflenet_v2/shufflenet_v2_x0.5_ascend.yaml --data_dir /path/to/imagenet
```
...
python train.py --config configs/shufflenet_v2/shufflenet_v2_x0.5_ascend.yaml --data_dir /path/to/dataset --distribute False
```
...
```
python validate.py -c configs/shufflenet_v2/shufflenet_v2_x0.5_ascend.yaml --data_dir /path/to/imagenet --ckpt_path /path/to/ckpt
```
